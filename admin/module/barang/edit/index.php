                  ...
                  <div class="col-lg-12 main-chart">
						...
						<table class="table table-striped">
							<form action="fungsi/edit/edit.php?barang=edit" method="POST">
								...
								<tr>
									<td>NO.Batch</td>
									<td><input type="text" class="form-control" value="<?php echo $hasil['merk2'];?>" name="merk2"></td>
								</tr>
								<tr>
									<td>TGL Kadaluarsa</td>
									<td><input type="date" class="form-control" value="<?php echo $hasil['merk3'];?>" name="merk3"></td>
								</tr>
								<tr>
									<td>Harga Beli</td>
