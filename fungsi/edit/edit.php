...
if(!empty($_SESSION['admin'])){
	...
	if(!empty($_GET['barang'])){
		...
		$merk2 = htmlentities($_POST['merk2']);
		$merk3 = htmlentities($_POST['merk3']);
		...
		$data[] = $tgl;
		$data[] = $id;
		$sql = 'UPDATE barang SET id_kategori=?, nama_barang=?, merk=?,merk2=?,merk3=?, 
	...
	?>
		...
		<?php foreach($hasil1 as $hasil){?>
			<tr>
				...
				<td><?php echo $hasil['merk2'];?></td>
				<td><?php echo $hasil['merk3'];?></td>
				<td><?php echo $hasil['harga_jual'];?></td>
				<td><?php echo $hasil['harga_jual1'];?></td>
				<td>
