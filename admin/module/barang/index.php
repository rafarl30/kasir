							...
							<table class="table table-bordered table-striped" id="example1">
								...
								?>
									<tr>
										...
										<td><?php echo $isi['merk2'];?></td>
										<td><?php echo $isi['merk3'];?></td>
										<td>
											<?php if($isi['stok'] == '0'){?>
								...
								<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
									<div class="modal-body">
										...
										<table class="table table-striped bordered">
											...
											<tr>
												<td>Pemasok</td>
												<td><input type="text" placeholder="pemasok" required class="form-control"  name="merk"></td>
											</tr>
											<tr>
												<td>NO.Batch</td>
												<td><input type="text" placeholder="No.Batch" required class="form-control"  name="merk2"></td>
											</tr>
											<tr>
												<td>TGL Kadaluarsa</td>
												<td><input type="date" placeholder="Tanggal" required class="form-control"  name="merk3"></td>
											</tr>
											<tr>
												<td>Harga Beli</td>
											...
											<tr>
												<td>Harga Jual</td>
												<td><input type="option" placeholder="Harga Jual" required class="form-control"  name="jual"></td>
											</tr>
											<tr>
												<td>Satuan Barang</td>
												<td>
