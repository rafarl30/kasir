					  ...
					  <div class="col-md-3">
                      		<div class="panel panel-primary">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-windows"></i> Nama Barang</h5>
                      			</div>
                      ...
                      <!-- STATUS PANELS -->
                      	<div class="col-md-3">
                      		<div class="panel panel-success">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-windows"></i> Stok Barang</h5>
                      			</div>
                      			<div class="panel-body">
                      ...
                      <!-- STATUS PANELS -->
                      	<div class="col-md-3">
                      		<div class="panel panel-info">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-windows"></i> Telah Terjual</h5>
                      			</div>
                      			<div class="panel-body">
                      	...
                      	<div class="col-md-3">
                      		<div class="panel panel-danger">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-windows"></i> Kategori Barang</h5>
                      			</div>
                      			<div class="panel-body">
